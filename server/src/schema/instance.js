...
export const INSTANCE_SCHEMA = {
  ...
  fields: [
    ...
    },
    {
      ...
      help: "Your provider's portal address and port, e.g. http://provider.example:8080",
      group: "Provider",
      required: true,
    ...
    // --- how it is reached --------------------------------------------------
    {
      ...
      help: "The address your players reach this instance at, e.g. https://tv.example.com/provider-1. Leave blank if it is not published externally.",
      group: "Addressing",
      required: true,
    ...
    // --- caching ------------------------------------------------------------
    {
      ...
      help: "Stores the VOD streams on the Docker host temporarily for faster and uninterrupted access.",
      type: "select",
      options: ["true", "false"],
      optionLabels: { true: "On", false: "Off" },
      default: "false",
    ...
    },
    {
      ...
      help: "Adds catchup (pause and rewind) functionality to any channel if not already offered by the provider. Starts buffering when a channel is first viewed, and keeps the last few hours of it.",
      type: "select",
      options: ["false", "true"],
      optionLabels: { true: "On", false: "Off" },
      default: "false",
    ...
    },
    {
      ...
      help: "A live channel id from your provider (as it appears in a stream URL) that the instance requests periodically to tell whether the provider is blocking this exit IP. Type a channel name to search, or enter the id directly.",
      type: "channelSearch",
      group: "Health check",
      required: true,
